...
public class GotoStatementConverter extends ConversionUtil {
    ...
    public void convertGotoStmt(JGotoStmt stmt, MethodVisitor mv, Body body, LocalIndexMapper indexMapper) {
        ...
        if (targetLabel == null) {
        	if(targetStmt instanceof JReturnStmt || targetStmt instanceof JReturnVoidStmt ) {
        		if (targetStmt instanceof JReturnVoidStmt) {
                    ...
                    return;
                }else if (targetStmt instanceof JReturnStmt) {
                    new ReturnStatementConverter().convertReturnStmt((JReturnStmt) targetStmt, mv, indexMapper);
                    return;
                }
        	}
