...
public class TextComparisonTool extends JFrame {
    ...
    private void displayLineBasedDiffs(JTextPane originalPane, JTextPane modifiedPane, LinkedList<Diff> diffs, List<String> originalLines, List<String> modifiedLines) {
